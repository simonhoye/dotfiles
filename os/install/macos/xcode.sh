...
agree_with_xcode_license() {
  ...
  print_result $? "Agree to the terms of the Xcode liense"
...
install_xcode() {
  ...
  # If necessary, prompt the user to install `Xcode`.

  if ! is_xcode_installed; then
    open "macappstore://itunes.apple.com/en/app/xcode/id497799835"
  fi
